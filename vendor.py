...
if criteria_file is not None and vendor_df is not None:
    ...
    # Compose filters: intersection of all active filters
    filters_lists = []
    ...
    # Calculate top score (across filtered vendors if filter applied)
